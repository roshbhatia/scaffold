...
run-starter:
	SCAFFOLD_CONFIG_PATH=dev/scaffold/std/config.yaml KUBECONFIG=.kind-kubeconfig.yaml go run ./cmd/starter/main.go

run-worker:
	SCAFFOLD_CONFIG_PATH=dev/scaffold/std/config.yaml KUBECONFIG=.kind-kubeconfig.yaml go run ./cmd/worker/main.go
